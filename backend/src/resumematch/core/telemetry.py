...
METRIC_ALLOWLIST = frozenset(
    {
        "extraction_success_total", "extraction_failure_total", "extraction_duration_seconds",
        "structuring_duration_seconds", "job_source_latency_seconds", "job_source_error_total",
        "postings_fetched_total", "postings_normalized_total", "postings_rejected_total",
        "scoring_duration_seconds", "scoring_exception_total", "llm_latency_seconds",
        "llm_error_total", "ungrounded_statement_total", "fabrication_attempt_total",
    }
)
LOG_FIELD_ALLOWLIST = frozenset(
    {
        ...
        "source_external_id", "job_internal_id", "field_paths", "content_hash", "provider_id",
        "provider_locality", "omitted_field_paths", "check_name", "item_id", "requirement_id",
        "page_numbers", "count", "reason_code",
    }
)
