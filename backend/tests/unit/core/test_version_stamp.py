...
def test_version_stamp_has_all_design_fields() -> None:
    ...
    expected = {
        "schema_version", "engine_version", "rubric_id", "rubric_version", "rubric_status",
        "alias_file_version", "evidence_multiplier_version", "match_weight_version",
        "threshold_version", "confidence_weight_version", "pattern_set_version",
        "delimitation_version", "relevance_rule_version",
    }
